  ...
  return (
    <div className="flex flex-col items-center">
      <header className='flex flex-col items-center'>
        ...
        <p className="flex justify-center">Pentru meniul de “Display Orientation” ,  daca avem optiunea vom alege “AUTO” ,  daca nu exista aceasta optiune alegem  varianta potrivita pozitionarii  monitorului</p>
