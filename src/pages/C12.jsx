  ...
  return (
    <div className="flex flex-col items-center">
      <header className='flex flex-col items-center'>
        ...
        <p className="flex justify-center xs:max-w-[300px]">Pentru setarea pinului vom trece peste FARA a seta un pin. Facem acest lucru prin a apasa sageata in dreapta pe telecomanda</p>
